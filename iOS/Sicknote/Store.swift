...
final class Store: ObservableObject {
    ...
    private let fileName = "sicknote_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Missed Class One", detail: "First example entry.", date: now),
            Entry(title: "Sample Missed Class Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Missed Class Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
